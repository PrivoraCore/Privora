...
class RawTransactionsTest(PrivoraTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid privora address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
