...
import RPC call and node 0 sends VORA to it. Then other nodes import the
...
In the second part of the test, node 0 sends more VORA to each address, and the
...
class ImportRescanTest(PrivoraTestFramework):
    def __init__(self):
        super().__init__()
