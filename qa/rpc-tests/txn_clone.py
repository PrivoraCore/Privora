...
class TxnMallTest(PrivoraTestFramework):
    ...
    def run_test(self):
        ...
        # 40 VORA serialized is 00286bee00000000
        pos0 = 2*(4+1+36+1+4+1)
        ...
        # Node0's balance should be starting balance, plus 40VORA for another
        ...
        # Check node0's total balance; should be same as before the clone, + 100 VORA for 2 matured,
