...
(define* (make-privora-cross-toolchain target
                                       #:key
...
desirable for building Privora Core release binaries."
...
(define glibc-2.27/privora-patched
		 ...
		 (make-nsis-with-sde-support nsis-x86_64)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-privora-cross-toolchain target
                                                      #:base-libc glibc-2.27/privora-patched
