...
#ifndef PRIVORA_QT_PRIVORAGUI_H
#define PRIVORA_QT_PRIVORAGUI_H
...
/**
  Privora GUI main class. This class represents the main window of the Privora UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class PrivoraGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit PrivoraGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~PrivoraGUI();
...
public Q_SLOTS:
    ...
    /** Switch directly to Privora history tab */
