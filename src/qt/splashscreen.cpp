...
SplashScreen::SplashScreen(const QPixmap &pixmap, Qt::WindowFlags f) : QSplashScreen(pixmap, f)
{
    ...
    //QString copyrightText1   = QChar(0xA9)+QString(" 2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Privora developers"));
    //QString copyrightText2   = QChar(0xA9)+QString(" 2011-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Litecoin developers"));
    //QString copyrightText3   = QChar(0xA9)+QString(" 2014 ") + QString(tr("The Privora developers"));
...
//
//    // draw the Privora icon, expected size of PNG: 1024x1024
