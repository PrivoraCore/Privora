...
#ifndef PRIVORA_QT_PRIVORAUNITS_H
#define PRIVORA_QT_PRIVORAUNITS_H
...
/** Privora unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PrivoraUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PrivoraUnits(QObject *parent);

    /** Privora units.
      @note Source: https://en.privora.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        VORA,
...
typedef PrivoraUnits::Unit PrivoraUnit;

#endif // PRIVORA_QT_PRIVORAUNITS_H
