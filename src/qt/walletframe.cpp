...
WalletFrame::WalletFrame(const PlatformStyle *_platformStyle, PrivoraGUI *_gui) :
    QFrame(_gui),
    gui(_gui),
...
void WalletFrame::gotoPrivoraHistoryTab()
{
    QMap<QString, WalletView*>::const_iterator i;
    for (i = mapWalletViews.constBegin(); i != mapWalletViews.constEnd(); ++i)
        i.value()->gotoPrivoraHistoryTab();
}
