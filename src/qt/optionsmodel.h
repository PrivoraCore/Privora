...
#ifndef PRIVORA_QT_OPTIONSMODEL_H
#define PRIVORA_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Privora client.
...
#endif // PRIVORA_QT_OPTIONSMODEL_H
