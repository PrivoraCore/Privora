...
#ifndef PRIVORA_QT_GUIUTIL_H
#define PRIVORA_QT_GUIUTIL_H
...
/** Utility functions used by the Privora Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "privora:" URI into recipient object, return true on successful parsing
