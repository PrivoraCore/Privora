...
#ifndef PRIVORA_QT_TRANSACTIONTABLEMODEL_H
#define PRIVORA_QT_TRANSACTIONTABLEMODEL_H
...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, PrivoraUnits::SeparatorStyle separators=PrivoraUnits::separatorStandard) const;
...
#endif // PRIVORA_QT_TRANSACTIONTABLEMODEL_H
