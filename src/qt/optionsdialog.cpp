    ...
    mapper(0)
{
    ...
    ui->privoraAtStartup->setToolTip(ui->privoraAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->privoraAtStartup->setText(ui->privoraAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new PrivoraUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->privoraAtStartup, OptionsModel::StartAtStartup);
