...
public:
    ...
    CPrivoraAddress getNotificationAddress() const;
    CPrivoraAddress getNthAddress(size_t idx) const;
...
typedef std::tuple<size_t, CPaymentCode, std::string, CPrivoraAddress, CPaymentCodeSide> CPaymentCodeDescription;
