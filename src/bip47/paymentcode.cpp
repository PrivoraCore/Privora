...
CPrivoraAddress CPaymentCode::getNotificationAddress() const
{
...
CPrivoraAddress CPaymentCode::getNthAddress(size_t idx) const
{
    return CPrivoraAddress(getNthPubkey(idx).pubkey.GetID());
}
