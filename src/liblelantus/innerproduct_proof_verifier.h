#ifndef PRIVORA_LIBLELANTUS_INNER_PRODUCT_PROOF_VERIFIER_H
#define PRIVORA_LIBLELANTUS_INNER_PRODUCT_PROOF_VERIFIER_H
...
#endif //PRIVORA_LIBLELANTUS_INNER_PRODUCT_PROOF_VERIFIER_H
