#ifndef PRIVORA_LIBLELANTUS_INNERP_RODUCT_PROOF_GENERATOR_H
#define PRIVORA_LIBLELANTUS_INNERP_RODUCT_PROOF_GENERATOR_H
...
#endif //PRIVORA_LIBLELANTUS_INNERP_RODUCT_PROOF_GENERATOR_H
