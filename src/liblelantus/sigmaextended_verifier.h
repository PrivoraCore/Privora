#ifndef PRIVORA_LIBLELANTUS_SIGMAEXTENDED_VERIFIER_H
#define PRIVORA_LIBLELANTUS_SIGMAEXTENDED_VERIFIER_H
...
#endif //PRIVORA_LIBLELANTUS_SIGMAEXTENDED_VERIFIER_H
