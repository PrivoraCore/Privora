...
{
    std::string strSecret = privora_address_to_privora(std::string("5Kg1gnAjaLfKiwhhPpGS3QfRg2m6awQvaj98JCZBZQ5SuS2F15C"));
...
BOOST_AUTO_TEST_CASE(rolling_bloom)
{
    ...
    // Run test_privora with --log_level=message to see BOOST_TEST_MESSAGEs:
