...
#ifndef PRIVORA_TEST_SCRIPTNUM10_H
#define PRIVORA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Privora Core 0.10.0, for cross-comparison.
 */
public:
