...
// Copyright (c) 2016-2017 The Privora developers

// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef PRIVORA_CONSENSUS_CONSENSUS_H
#define PRIVORA_CONSENSUS_CONSENSUS_H
...
#endif // PRIVORA_CONSENSUS_CONSENSUS_H
