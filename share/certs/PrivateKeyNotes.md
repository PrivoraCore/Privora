...
unlocked to sign the Privora-Qt.app bundle.
...
allowing somebody to distribute a Privora-Qt.app or privora-qt-setup.exe with a valid
...
that the privora-qt.exe file inside the installer had not been tampered with.
