...
This document provides guidelines for internationalization of the Privora Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `privora_en.ts` remains unchanged.
