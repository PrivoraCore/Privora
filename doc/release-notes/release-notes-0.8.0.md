Privora-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/privora/files/Privora/privora-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Privora
...
New/changed settings (command-line or privora.conf file)
--------------------------------------------------------
