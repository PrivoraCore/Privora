Privora Core version 0.13.2 is now available from:

  <https://privora.org/bin/privora-core-0.13.2/>
...
- #8908 `4a974b2` Update privora-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow privora-tx to create v2 transactions (btcdrak)
