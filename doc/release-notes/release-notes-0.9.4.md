Privora Core version 0.9.4 is now available from:

  https://privora.org/bin/0.9.4/
...
this update is incompatible with the Privora system and could lead to consensus
forks.

Privora Core released binaries from https://privora.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~privora/+archive/ubuntu/privora
- A third-party or self-compiled Privora Core

upgrade to Privora Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
