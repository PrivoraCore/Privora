Privora Core version 0.9.2.1 is now available from:

  https://privora.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 VORA to 0.01 VORA
...
- Fix "Start privora on system login"
