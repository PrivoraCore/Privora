Privora Core version 0.10.4 is now available from:

  <https://privora.org/bin/privora-core-0.10.4/>
...
- #6953 `43c2789` Split privora-tx into its own package
- #6953 `dfe0d4d` Include privora-tx binary on Debian/Ubuntu
