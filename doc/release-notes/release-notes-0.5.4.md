Privora version 0.5.4 is now available for download at:
http://sourceforge.net/projects/privora/files/Privora/privora-0.5.4/
...
http://gitorious.org/privora/privorad-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Privora-Qt notifications under Growl 1.3.
Increase required age of Privora-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPrivora properly when installing Privora-Qt over it. (Windows)
